...
const SignInForm: FC<Props> = ( { className, ...others } ) => {
  ...
  return (
    <form onSubmit={handleFormSubmit} className={twMerge( 'w-full sm:w-80 relative', className )} {...others}>
      ...
      <p className="mt-5 text-center">Don&apos;t have an account? <Link to={`/signup?${searchParams.toString()}`} className="font-bold decoration-[.1rem] hover:underline">Register</Link></p>
