  ...
  return (
    <article className="flex bg-zinc-100 rounded-2xl">
      ...
      <div className="w-full">
        <div className="flex">
          <h3 className="w-12.5 h-12.5 px-3 flex items-center grow font-bold"><Link to={`${isAdmin ? '/admin' : ''}/order/${order._id}`} className="line-clamp-1">Order #{order._id.slice( -6 )}</Link></h3>
